...
const HeroSection = () =>
{
  ...
  useGSAP(() => {
    ...
    tl.from(".animate1", { opacity: 0, scale: 0.5 });
    tl.from(".animate2", { opacity: 0, scale: 0.5 });
    tl.from(".animate3", { opacity: 0, scale: 0.5 });
  });
  ...
  return (
    ...
    >
      ...
      <div className="relative  z-10 px-10 py-14  text-white flex justify-center text-center gap-2 flex-col ">
        <h1 className=" text-4xl animate md:text-6xl font-black leading-11 bg-gradient-to-b from-[#c5bfc8] via-[#ffff] to-[#bbb5c8] bg-clip-text text-transparent  md:max-w-[50%] mx-auto pb-2 md:leading-16 ">
          Start AI for Your Everyday Needs
        </h1>
        <p className="font-medium animate text-sm md:text-[20px] pb-4 md:max-w-[39%] mx-auto font-sora ">
        ...
        <div className=" mt-5 animate1 rounded-full overflow-clip flex justify-center shadow-lg md:w-[400px]  mx-auto ">
          <img
            src="https://res.cloudinary.com/dk5mfu099/image/upload/v1747748989/gpt-phone-1-removebg-preview_dsyoa6.png"
            alt="AI image"
          />
        </div>
        <div className="animate2 hidden md:flex absolute w-[300px] h-[200px] rounded-2xl shadow-nav skew-6 bg-white/5 backdrop-blur-md shadow-[#e4c16794] p-3  flex-col justify-center gap-2 left-[-50px] xl:left-0 ">
        ...
        <div className="animate3 hidden md:flex flex-col absolute w-[300px] h-[200px] rounded-2xl right-0  shadow-nav shadow-[#ffffff81] skew-x-12 bg-white/5 backdrop-blur-md justify-center px-3">
