...
const HeroSection = () => {
  return (
    <div
      className="
             min-h-[110vh] md:min-h-[120vh] pt-[160px] mt-[-100px] md:px-46 px-3 bg-[#0A0A0A] overflow-clip relative"
    >
      ...
      <div className="relative z-10 px-10 py-14  text-white flex justify-center text-center gap-2 flex-col">
        ...
        <div className=" hidden md:flex absolute w-[300px] h-[200px] rounded-2xl shadow-nav skew-6 bg-white/5 backdrop-blur-md shadow-[#e4c16794] p-3  flex-col justify-center gap-2 mr-5">
        ...
        <div className=" hidden md:flex flex-col absolute w-[300px] h-[200px] rounded-2xl right-0  shadow-nav shadow-[#ffffff81] skew-x-12 bg-white/5 backdrop-blur-md justify-center px-3">
          ...
          <div className=" flex px-4 items-center gap-3">
            ...
            <span className='ml-auto bg-white text-black rounded-2xl p-1 text-[10px] font-bold'>Best Value</span>
          </div>
          <div className=" flex px-4 items-center gap-3">
            <span className="border-2 rounded-full w-[20px] h-[20px]"></span>
            <div>
