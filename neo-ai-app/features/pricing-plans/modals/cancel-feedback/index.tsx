...
export function CancellationFeedbackModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md min-h-[484px] shadow-sm  bg-white/1 rounded-3xl transition-all font-sora backdrop-blur-md  text-white shadow-[#52398a] border-0 ring-[#52398a] ring">
