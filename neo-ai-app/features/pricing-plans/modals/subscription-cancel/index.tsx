...
export function SubscriptionCanceledModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md h-[259px] md:h-[220px] md:w-[533px] shadow-sm  bg-white/1 rounded-3xl transition-all font-sora backdrop-blur-md  text-white shadow-[#52398a] border-0 ring-[#52398a] rin">
        <DialogHeader className="gap-2 items-center">
          ...
          <DialogDescription className="text-center text-white">
            Your plan will remain active until {expiryDate}. You can resubscribe
            anytime.
          </DialogDescription>
        </DialogHeader>
